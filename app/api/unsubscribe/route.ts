  ...
  return htmlPage(
    `<h2>Unsubscribe?</h2>
     ...
     <form method="POST" action="${escapeHtml(action)}">
       <button type="submit" style="background:#7c3aed;color:#fff;border:none;padding:10px 20px;border-radius:6px;font-size:14px;cursor:pointer">Yes, unsubscribe</button>
     </form>
     <p style="margin-top:16px"><a href="/" style="color:#7c3aed">No, keep me subscribed</a></p>`
  )
}
